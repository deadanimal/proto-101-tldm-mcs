...
@Component({
  selector: "app-mc-sp-and-international",
  templateUrl: "./mc-sp-and-international.component.html",
  styleUrls: ["./mc-sp-and-international.component.scss"],
})
export class McSpAndInternationalComponent implements OnInit, OnDestroy {
  // Chart
  chart: any;
  ...
  getChart() {
    //chart nate susoh
    let container = am4core.create("chartdivSpInter", am4core.Container);
  ...
  getChart1() {
    // chart half circle
    let chart = am4core.create("chartdivSpInter1", am4charts.PieChart);
  ...
  getChart2() {
    // chart ada gambo org
    let chart = am4core.create("chartdivSpInter2", am4charts.XYChart);
  ...
  getChart3() {
    ...
    let chart = am4core.create("chartdivSpInter3", am4charts.XYChart);
  ...
  getChart4() {
    ...
    let chart = am4core.create("chartdivSpInter4", am4charts.XYChart);
  ...
  getChart5() {
    // chart bar 2 line
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartdivSpInter5", am4charts.XYChart);
    chart.colors.step = 2;
  ...
  getChart6() {
    // pie chart
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartdivSpInter6", am4charts.PieChart);
