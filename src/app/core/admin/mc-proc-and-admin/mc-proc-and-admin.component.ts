...
@Component({
  selector: "app-mc-proc-and-admin",
  templateUrl: "./mc-proc-and-admin.component.html",
  styleUrls: ["./mc-proc-and-admin.component.scss"],
})
export class McProcAndAdminComponent implements OnInit, OnDestroy {
  // Chart
  chart: any;
  ...
  listBillStatement: any = [
    {
      name: "Ali",
      item:"Desk",
      type:"Standard Purchase Orders (PO)",
      amount:"RM3000",
    ...
    },
    {
      name: "Sarah",
      item:"Cabinet",
      type:"Planned Purchase Orders (PPO)",
      amount:"RM5000",
      created_at: "2019-07-27T01:07:14Z",
    },
    {
      name: "Ali",
      item:"Television",
      type:"Blanket Purchase Orders (BPO)",
      amount:"RM6000",
      created_at: "2019-07-27T01:07:14Z",
    },
  ];
